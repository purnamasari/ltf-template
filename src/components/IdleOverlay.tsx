...
export function IdleOverlay({
  ...
  return (
    <Sky>
      ...
      >
        {/* The whole screen is the dismiss target, as the card says — and the
            screen, not the frame, so the paper either side of it dims too. */}
        <button
          type="button"
        ...
        <StageFrame>
          <div className="pointer-events-auto absolute left-[172px] top-[220px] h-[395px] w-[850px] overflow-hidden rounded-[19px] bg-cream shadow-[0px_3px_2.1px_0px_rgba(0,0,0,0.07),inset_0px_1px_10.3px_0px_rgba(175,145,105,0.18)]">
