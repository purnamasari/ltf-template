...
function TermsDialog({ onAgree, onClose }: { onAgree: () => void; onClose: () => void }) {
  return (
    ...
    >
      ...
      <div className="absolute left-[119px] top-[107px] h-[600px] w-[952px] rounded-[19px] bg-cream shadow-[0px_3px_2.1px_0px_rgba(0,0,0,0.07),inset_0px_1px_10.3px_0px_rgba(175,145,105,0.18)]">
        ...
        <div className="absolute left-[67px] top-[187px] w-[822px] text-[20px] leading-[26px] text-ink">
          <p>
            By clicking I Agree, you agree to our [Terms of Service] and consent to our handling of
            your data as outlined below:
          </p>
          <ul className="mt-[20px] list-disc pl-[30px]">
            <li>
              Data Collection &amp; Purpose: We collect your contact information (email address or
              WeChat username) and the content of your postcard solely to process, store, and
            ...
            <li>
              Data Retention &amp; Deletion: We retain your information only as long as necessary to
              complete delivery. Once your postcard has been delivered, your contact details and
              message will be permanently deleted or anonymized, except where retention is required
              by applicable law.
            </li>
          </ul>
        </div>
        ...
        {/*
          Decline closes the dialog without recording agreement — the same as the
          cross. The frame does not say whether it should also abandon the
        ...
        */}
        ...
        <PillButton
          className="left-[490px] top-[501px]"
          variant="primary"
          onClick={onAgree}
        >
          I Agree
